#!/bin/bash
# Stage 1a — LiDAR-LLM-style cross-modal alignment on nuCaption.
set -e
...
OUT_DIR="$DATA_ROOT/checkpoints/qwen_lidarllm_stage1_align_999"
...
STAGE1A_EPOCHS="${STAGE1A_EPOCHS:-6}"
STAGE1A_LR="${STAGE1A_LR:-1e-4}"
...
CUDA_VISIBLE_DEVICES=$GPUS torchrun \
    ...
    --output_dir "$OUT_DIR" \
    --bf16 True \
    --num_train_epochs "$STAGE1A_EPOCHS" \
    ...
    --report_to wandb \
    --run_name qwen_lidarllm_stage1_align_999 \
    "$@"
